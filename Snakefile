...
rule get_seqs:
    ...
    shell:
        ...
        bash ../../{params.script} {params.prefix} {params.dir} {input.ingroup} {input.outgroup} 1> ../../{log.stdout} 2> ../../{log.stderr}
...
rule post_filter:
    ...
    shell:
        ...
        bash ../{params.script} ../per_gene/ {params.minlen} {params.mincount} 1> ../{log.stdout} 2> ../{log.stderr}
...
rule infer_supermatrix_ML:
    ...
    params:
        script = "bin/create_partitions.sh"
    singularity:
        "docker://chrishah/raxml-docker:8.2.12"
    threads: 6
    log:
	...
	bash ../{params.script} ../post-filtering-concat 1> ../{output.partitions} 2> partitions.err
